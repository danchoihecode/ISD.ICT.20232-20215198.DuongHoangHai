...
7.Software displays and temporarily save invoice information.
8.Customer choose the usual delivery method.
(9-13 are steps in basic flow of "Pay for the order" use case)
9.Customer selects payment method supported by VNPay.
10.Customer provide the necessary information as requested by VNPay to 
...
ALTERNATIVE FLOW (steps in basic flow of "Select rush order delivery" use case)
8a. Customer selects rush order delivery method.
8a1.Software checks eligibility for rush order delivery successfully.
8a2.Software requests additional rush order delivery information from the customer 
